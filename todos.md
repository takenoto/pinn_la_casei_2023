...
- TODO redo index sumário referências etc
- TODO email DEQ
...
- ✅ Metodologia
  ...
  - ✅ Explicar que a adimensionalização se dá na entrada, então as equações são trabalhadas normalmente por dentro. Não precisa de mais nada disso que fiz aí...
  - ✅ Preciso de uma figura explicando essa adimensionalização
  - ✅ Trocar referências de CSTR para CR (reator contínuo)
  - ✅ Retirar todas as eqs adimensionais. Elas se tornaram desnecessárias.
  - Organizar ordem em que as coisas são apresentadas. Não faz sentido falar logo da adimensionalização se ela só vier no fim!
    - ✅ 1) Modelo Cinético + dados XP
    - 2) Design do Estudo (variáveis estudadas, HL e LR, etc)
      - Fala das 3 redes (CR, batch, cinética) estudados (variáveis de processo) e variáveis cinéticas
